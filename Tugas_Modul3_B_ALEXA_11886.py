...
st.markdown("""
        ...
        .stSidebarh3, .stSidebar p, .stSidebar label, .stSidebar .header-text {
            color: #ffffff;
        }
        h1 {
...
st.markdown("<h1 style='text-align:center; color: #4CAF50;'>Prediksi IPK - 1886</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\Acer\OneDrive\Documents\Tugas cool yeah sekar\SEMESTER 5\Pembelajaran Mesin\Supervised Learning (Praktek)\Model Suprevised Learning (Praktek)\Tugas3_B_11886'
    ...
    if os.path.exists(model_path):
        ...
        st.error("Model tidak ditemukan, silakan cek file model di direkstori.")
